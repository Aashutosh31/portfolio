...
export const DATA = {
  personal: {
    ...
    headline: "Building AI Systems & Full Stack Products.",
  ...
  insights: [
    { title: "What Redis Taught Me About Scaling", date: "Engineering Log", readTime: "Architecture", desc: "Moving from local state to a distributed Redis pub/sub model was the key to making WebChat horizontally scalable. It fundamentally changed how I view stateless architecture." },
    { title: "The Nightmare of State Synchronization", date: "Engineering Log", readTime: "Frontend", desc: "Phantom messages and UI desyncs are the hardest part of real-time apps. I solved this by strictly chaining MongoDB writes before acknowledging Socket.IO emits." },
    { title: "Taming the AI Context Window", date: "Engineering Log", readTime: "AI Systems", desc: "Naive LLM wrappers fail at scale. Building ARC-AI required a dedicated RAG pipeline with Pinecone to explicitly separate working context from long-term memory." }
  ],
  roadmap: [
    { topic: "System Design", target: "Advanced", current: "Intermediate", reason: "To architect systems capable of handling millions of concurrent users." },
    { topic: "Docker & CI/CD", target: "Proficient", current: "Beginner", reason: "To standardize deployment pipelines and containerize distributed services." },
    { topic: "Cybersecurity", target: "Intermediate", current: "Beginner", reason: "To build robust applications that protect user data from Day 1." },
    { topic: "Git and GitHub", target: "Advanced", current: "Intermediate", reason: "To manage version control and collaborate effectively with other developers." }
  ],
  buildingInPublic: [
    { date: "May 2026", title: "Launched ARC-AI v0.13.0", type: "Release", desc: "Successfully shipped true multi-workspace isolated environments. Complete rewrite of the runtime layer." },
    { date: "April 2026", title: "WebChat Redis Migration", type: "Architecture", desc: "Moved presence tracking and socket coordination entirely to Redis, reducing server memory load by 40%." },
    { date: "Jan 2026", title: "LiveKit WebRTC Integration", type: "Feature", desc: "Bypassed standard server routing to implement Discord-style voice rooms in WebChat." },
    { date: "Nov 2025", title: "First Pinecone RAG Implementation", type: "Experiment", desc: "Successfully indexed a 50-page PDF and retrieved exact semantic matches using Mistral embeddings." }
  ],
  skills: {
  ...
  timeline: [
    ...
    { year: "2025", title: "Deepened Understanding of Real-Time Communication and Backend ", desc: "Explored advanced patterns for handling real-time data synchronization and backend service orchestration." },
  ...
  projects: [
    ...
    },
    {
      ...
      metrics: { time: "8 Months", complexity: "Extreme", status: "v0.13.0-beta", architecture: "Event-Driven Microservices", loc: "22,000+", endpoints: "30+", collections: "8+" },
